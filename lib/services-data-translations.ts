...
export const servicesTranslations: Record<string, ServiceTranslations> = {
  'identity-access-management': {
    ...
    addingValue: {
      ...
      content: { en: "Implementing an IAM system isn't just about securing access; it's about enhancing the overall efficiency and security posture of your business. With New Way's IAM solutions, you can:", ar: 'تنفيذ نظام IAM ليس فقط حول تأمين الوصول؛ بل يتعلق بتعزيز الكفاءة الإجمالية والوضع الأمني لعملك. باستخدام حلول IAM من New Way، يمكنك:' },
      benefits: [
    ...
    process: {
      ...
      content: { en: 'Our IAM service follows a clear, systematic process to ensure everything is set up correctly and aligned with your security goals:', ar: 'تتبع خدمة IAM الخاصة بنا عملية واضحة ومنهجية لضمان إعداد كل شيء بشكل صحيح ومتوافق مع أهدافك الأمنية:' },
      steps: [
        ...
        { title: { en: 'Implementation & Configuration', ar: 'التنفيذ والتكوين' }, description: { en: 'Our team sets up the IAM system, integrating it with your existing infrastructure and security tools.', ar: 'يقوم فريقنا بإعداد نظام IAM، ودمجه مع البنية التحتية وأدوات الأمان الحالية لديك.' } },
        ...
        { title: { en: 'Ongoing Support & Monitoring', ar: 'الدعم والمراقبة المستمرة' }, description: { en: 'After implementation, we offer continuous support to ensure your IAM system is always running smoothly, including periodic health checks and troubleshooting as needed.', ar: 'بعد التنفيذ، نقدم دعمًا مستمرًا لضمان تشغيل نظام IAM الخاص بك بسلاسة دائمًا، بما في ذلك الفحوصات الصحية الدورية واستكشاف الأخطاء وإصلاحها حسب الحاجة.' } }
      ]
    },
    closingStatement: { en: "At New Way, we aim to make securing your digital infrastructure simple and effective. If you're looking for a solution that helps protect your business while streamlining the access process, we're here to help. Reach out today to learn how we can make your IAM system work better for you.", ar: 'في New Way، نهدف إلى جعل تأمين البنية التحتية الرقمية الخاصة بك بسيطة وفعالة. إذا كنت تبحث عن حل يساعد في حماية عملك مع تبسيط عملية الوصول، فنحن هنا للمساعدة. تواصل معنا اليوم لمعرفة كيف يمكننا جعل نظام IAM الخاص بك يعمل بشكل أفضل لك.' }
  },
  'single-sign-on': {
    title: { en: 'Single Sign-On (SSO)', ar: 'تسجيل الدخول الموحد (SSO)' },
    description: { en: 'Managing multiple passwords for different applications can be a hassle for users and a security risk for organizations. Our SSO solutions streamline authentication while enhancing security.', ar: 'إدارة كلمات مرور متعددة لتطبيقات مختلفة يمكن أن تكون مشكلة للمستخدمين وخطرًا أمنيًا للمؤسسات. تعمل حلول SSO الخاصة بنا على تبسيط المصادقة مع تعزيز الأمان.' },
    fullDescription: { en: "Our Single Sign-On (SSO) solution eliminates the need for users to remember multiple passwords while significantly improving your organization's security posture. By providing a single authentication point, we make it easier for users to access all their applications while maintaining strict security controls.", ar: 'يلغي حل تسجيل الدخول الموحد (SSO) الخاص بنا حاجة المستخدمين إلى تذكر كلمات مرور متعددة مع تحسين الوضع الأمني لمؤسستك بشكل كبير. من خلال توفير نقطة مصادقة واحدة، نسهل على المستخدمين الوصول إلى جميع تطبيقاتهم مع الحفاظ على ضوابط أمنية صارمة.' },
    howItWorks: {
      title: { en: 'How It Works', ar: 'كيف يعمل' },
      content: { en: 'SSO works by authenticating users once and then providing secure access to all connected applications without requiring additional logins:', ar: 'يعمل SSO من خلال مصادقة المستخدمين مرة واحدة ثم توفير وصول آمن إلى جميع التطبيقات المتصلة دون الحاجة إلى عمليات تسجيل دخول إضافية:' },
      points: [
